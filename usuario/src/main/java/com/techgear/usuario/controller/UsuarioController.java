...
@CrossOrigin(origins = "http://localhost:34.239.178.87") 
...
public class UsuarioController {
    ...
    @ApiResponse(responseCode = "200", description = "Listado de usuarios", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = Usuario.class))))
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "El correo ya está registrado o datos inválidos") // <-- Mapeamos el error aquí
    })
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Usuario actualizado", content = @Content(mediaType = "application/json", schema = @Schema(implementation = Usuario.class))),
            @ApiResponse(responseCode = "404", description = "Usuario no encontrado")
    })
